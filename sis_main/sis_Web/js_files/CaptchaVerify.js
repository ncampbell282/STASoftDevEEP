...
// Mouse Tracker 
var xInitial; //Initial x-value
var yInitial; //Initial y-value
var mouseCounter = 0;
var mousePrev = 0;
...
window.addEventListener('mousemove', function(e) // Listener to fire when mouse movement detected
    {
        ...
        //Set initial x,y value, so mouse changes can be found
       if(xInitial == undefined && yInitial == undefined) {
           xInitial = e.x;
           yInitial = e.y;
           console.log("Mouse xInitial: " + e.x + " Mouse yInitial: " + e.y)
       } 
       console.log("Mouse x: " + e.x + " Mouse y: " + e.y)
       if(e.x != xInitial || e.y != yInitial) {
           mouseCounter += 1; // Counts every time a mouse movement is evident
       }
    });
...
function attemptLogin() {
    ...
    return false; //Return if form sucessfully submitted
}
...
function sendCredentials() {
    ...
    xmlhttp.open("POST", "http://localhost:3000/sis_main/phpServer/verifylogin.php", true);
